...
@section('content')
    <h2 class="text-2xl font-bold mb-6">Edit Genre</h2>

    <form action="{{ route('admin.genres.update', $genre) }}" method="POST" class="bg-white p-6 rounded shadow w-full max-w-lg">
        @csrf
        @method('PUT')
        <div class="mb-4">
